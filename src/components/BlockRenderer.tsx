...
export default function BlockRenderer({ block, onChange, readOnly = false }: BlockRendererProps) {
  switch (block.type) {
    case 'text':
    ...
    case 'bodymap':
      return <BodyMapBlock block={block} onChange={onChange} readOnly={readOnly} />;
